...
public class FormPanel2 extends JPanel {
	 ...
	 * Staff Form 
	 */
	private static final long serialVersionUID = 2275864308442823480L;
...
//				ClientFormEvent ev = new ClientFormEvent(this, name, occupation, ageCat
...
//	private String text;
//
//	public AgeCategory2(int id, String text) {
//		this.id = id;
//		this.text = text;
//	}
//
